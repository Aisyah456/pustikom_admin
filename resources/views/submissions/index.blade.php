<x-layouts.app :title="__('Pengajuan')">
    <div class="container mx-auto p-6">
          <flux:heading size="xl" level="1">{{ __('📑 Daftar Pengajuan Surat Masuk') }}</flux:heading>
        </div>
        ...
        <div class="mb-6">
            {{-- Component untuk membuat Pengajuan baru --}}
            @livewire('submission-form') 
        </div>

        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            {{-- Component PowerGrid untuk daftar dan filter Pengajuan --}}
